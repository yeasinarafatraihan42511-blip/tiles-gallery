...
const Banner = () => {
  return (
    <div className="h-[60vh] w-full rounded-xl overflow-hidden shadow-xl banner-animate relative">
  ...
  <div className="absolute inset-0 bg-black/60 flex items-center">
    <div className="max-w-7xl mx-auto px-6 text-white">
      ...
      <p className="text-lg md:text-xl mb-6 max-w-xl text-gray-200">
        Explore premium tiles crafted for modern interiors.
      </p>

      <Link href="/all-tiles">
        <button className="px-6 py-2 bg-amber-600 text-white rounded-full hover:bg-amber-700">
          Browse Now
        </button>
      </Link>
